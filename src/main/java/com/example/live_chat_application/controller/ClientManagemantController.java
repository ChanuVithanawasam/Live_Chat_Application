package com.example.live_chat_application.controller;

import animatefx.animation.FadeIn;
import com.example.live_chat_application.model.User;
...
import static com.example.live_chat_application.controller.CreateNewUserAccountController.users;
...
public class ClientManagemantController extends Thread implements Initializable {
        ...
        try {
            while (true) {
                ...
                if (fChar.equalsIgnoreCase("img")) {
                    ...
                    textFlow.setStyle("-fx-background-color:#8105f7;" + "-fx-background-radius: 20px;"+"-fx-font-size: 17px;");
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        if (CreateNewUserAccountController.gender.equalsIgnoreCase("Male")) {
            image = new Image("com/example/live_chat_application/assests/images/userMale.png", false);
        } else {
            image = new Image("com/example/live_chat_application/assests/images/userFemale.png", false);
            imgPhotoMain.setImage(image);
        }
        showProPic.setFill(new ImagePattern(image));
    ...
    public void emojiBtnOnAction(MouseEvent mouseEvent) throws IOException {
        URL resource = getClass().getResource("/com/example/live_chat_application/EmojiController.fxml");
